...
namespace FoodHeaven.Migrations
{
    ...
    [Migration("20260117144523_UpdateMenuImages")]
            ...
            modelBuilder.Entity("FoodHeaven.Models.Admin", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1,
                            CreatedAt = new DateTime(2026, 1, 17, 19, 45, 22, 828, DateTimeKind.Local).AddTicks(5159),
                            Email = "admin@foodheaven.com",
                            FullName = "Admin User",
                            IsActive = true,
                            PasswordHash = "$2a$11$2uTJL3KrhtqjxSgeDapfH.1hqK/XpRjH78OBd3WeVQBWmv1ivWhJO",
                            Username = "admin"
                        });
                });
            ...
            modelBuilder.Entity("FoodHeaven.Models.MenuItem", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = 1,
                            Category = "Mains",
                            CreatedAt = new DateTime(2026, 1, 17, 19, 45, 22, 686, DateTimeKind.Local).AddTicks(357),
                        ...
                        new
                        {
                            Id = 2,
                            Category = "Mains",
                            CreatedAt = new DateTime(2026, 1, 17, 19, 45, 22, 686, DateTimeKind.Local).AddTicks(379),
                        ...
                        new
                        {
                            Id = 3,
                            Category = "Mains",
                            CreatedAt = new DateTime(2026, 1, 17, 19, 45, 22, 686, DateTimeKind.Local).AddTicks(382),
                        ...
                        new
                        {
                            Id = 4,
                            Category = "Mains",
                            CreatedAt = new DateTime(2026, 1, 17, 19, 45, 22, 686, DateTimeKind.Local).AddTicks(384),
                        ...
                        new
                        {
                            Id = 5,
                            Category = "Mains",
                            CreatedAt = new DateTime(2026, 1, 17, 19, 45, 22, 686, DateTimeKind.Local).AddTicks(386),
                        ...
                        new
                        {
                            Id = 6,
                            Category = "Starters",
                            CreatedAt = new DateTime(2026, 1, 17, 19, 45, 22, 686, DateTimeKind.Local).AddTicks(388),
                        ...
                        new
                        {
                            Id = 7,
                            Category = "Drinks",
                            CreatedAt = new DateTime(2026, 1, 17, 19, 45, 22, 686, DateTimeKind.Local).AddTicks(390),
                        ...
                        new
                        {
                            Id = 8,
                            Category = "Healthy",
                            CreatedAt = new DateTime(2026, 1, 17, 19, 45, 22, 686, DateTimeKind.Local).AddTicks(392),
                        ...
                        new
                        {
                            Id = 9,
                            Category = "Desserts",
                            CreatedAt = new DateTime(2026, 1, 17, 19, 45, 22, 686, DateTimeKind.Local).AddTicks(394),
