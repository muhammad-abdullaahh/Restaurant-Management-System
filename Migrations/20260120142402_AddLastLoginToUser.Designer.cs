...
namespace FoodHeaven.Migrations
{
    ...
    [Migration("20260120142402_AddLastLoginToUser")]
            ...
            modelBuilder.Entity("FoodHeaven.Models.Admin", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1,
                            CreatedAt = new DateTime(2026, 1, 20, 19, 24, 1, 629, DateTimeKind.Local).AddTicks(6640),
                            Email = "admin@foodheaven.com",
                            FullName = "Admin User",
                            IsActive = true,
                            PasswordHash = "$2a$11$kTsbZMbK5VwY1pz1uieYO.CHmSpAhnKzBluz2C5vs4aosKXxnYkKe",
                            Username = "admin"
                        });
                });
            ...
            modelBuilder.Entity("FoodHeaven.Models.MenuItem", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = 1,
                            Category = "Mains",
                            CreatedAt = new DateTime(2026, 1, 20, 19, 24, 1, 432, DateTimeKind.Local).AddTicks(1218),
                        ...
                        new
                        {
                            Id = 2,
                            Category = "Mains",
                            CreatedAt = new DateTime(2026, 1, 20, 19, 24, 1, 432, DateTimeKind.Local).AddTicks(1240),
                        ...
                        new
                        {
                            Id = 3,
                            Category = "Mains",
                            CreatedAt = new DateTime(2026, 1, 20, 19, 24, 1, 432, DateTimeKind.Local).AddTicks(1244),
                        ...
                        new
                        {
                            Id = 4,
                            Category = "Mains",
                            CreatedAt = new DateTime(2026, 1, 20, 19, 24, 1, 432, DateTimeKind.Local).AddTicks(1247),
                        ...
                        new
                        {
                            Id = 5,
                            Category = "Mains",
                            CreatedAt = new DateTime(2026, 1, 20, 19, 24, 1, 432, DateTimeKind.Local).AddTicks(1250),
                        ...
                        new
                        {
                            Id = 6,
                            Category = "Starters",
                            CreatedAt = new DateTime(2026, 1, 20, 19, 24, 1, 432, DateTimeKind.Local).AddTicks(1252),
                        ...
                        new
                        {
                            Id = 7,
                            Category = "Drinks",
                            CreatedAt = new DateTime(2026, 1, 20, 19, 24, 1, 432, DateTimeKind.Local).AddTicks(1254),
                        ...
                        new
                        {
                            Id = 8,
                            Category = "Healthy",
                            CreatedAt = new DateTime(2026, 1, 20, 19, 24, 1, 432, DateTimeKind.Local).AddTicks(1256),
                        ...
                        new
                        {
                            Id = 9,
                            Category = "Desserts",
                            CreatedAt = new DateTime(2026, 1, 20, 19, 24, 1, 432, DateTimeKind.Local).AddTicks(1258),
