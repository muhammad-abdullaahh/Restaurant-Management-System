...
namespace FoodHeaven.Migrations
{
    ...
    [Migration("20260119163027_AddDeliveryDetailsToOrder")]
            ...
            modelBuilder.Entity("FoodHeaven.Models.Admin", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1,
                            CreatedAt = new DateTime(2026, 1, 19, 21, 30, 26, 499, DateTimeKind.Local).AddTicks(5827),
                            Email = "admin@foodheaven.com",
                            FullName = "Admin User",
                            IsActive = true,
                            PasswordHash = "$2a$11$gGVjOrhUL2K/5lbG/94PluhG5JpRgrzNwEewQDuNdCFZxIxSU.H4.",
                            Username = "admin"
                        });
                });
            ...
            modelBuilder.Entity("FoodHeaven.Models.MenuItem", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = 1,
                            Category = "Mains",
                            CreatedAt = new DateTime(2026, 1, 19, 21, 30, 26, 348, DateTimeKind.Local).AddTicks(9424),
                        ...
                        new
                        {
                            Id = 2,
                            Category = "Mains",
                            CreatedAt = new DateTime(2026, 1, 19, 21, 30, 26, 348, DateTimeKind.Local).AddTicks(9441),
                        ...
                        new
                        {
                            Id = 3,
                            Category = "Mains",
                            CreatedAt = new DateTime(2026, 1, 19, 21, 30, 26, 348, DateTimeKind.Local).AddTicks(9444),
                        ...
                        new
                        {
                            Id = 4,
                            Category = "Mains",
                            CreatedAt = new DateTime(2026, 1, 19, 21, 30, 26, 348, DateTimeKind.Local).AddTicks(9446),
                        ...
                        new
                        {
                            Id = 5,
                            Category = "Mains",
                            CreatedAt = new DateTime(2026, 1, 19, 21, 30, 26, 348, DateTimeKind.Local).AddTicks(9448),
                        ...
                        new
                        {
                            Id = 6,
                            Category = "Starters",
                            CreatedAt = new DateTime(2026, 1, 19, 21, 30, 26, 348, DateTimeKind.Local).AddTicks(9450),
                        ...
                        new
                        {
                            Id = 7,
                            Category = "Drinks",
                            CreatedAt = new DateTime(2026, 1, 19, 21, 30, 26, 348, DateTimeKind.Local).AddTicks(9494),
                        ...
                        new
                        {
                            Id = 8,
                            Category = "Healthy",
                            CreatedAt = new DateTime(2026, 1, 19, 21, 30, 26, 348, DateTimeKind.Local).AddTicks(9497),
                        ...
                        new
                        {
                            Id = 9,
                            Category = "Desserts",
                            CreatedAt = new DateTime(2026, 1, 19, 21, 30, 26, 348, DateTimeKind.Local).AddTicks(9499),
