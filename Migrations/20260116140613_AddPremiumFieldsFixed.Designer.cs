...
namespace FoodHeaven.Migrations
{
    ...
    [Migration("20260116140613_AddPremiumFieldsFixed")]
    partial class AddPremiumFieldsFixed
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("FoodHeaven.Models.Admin", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1,
                            CreatedAt = new DateTime(2026, 1, 16, 19, 6, 12, 748, DateTimeKind.Local).AddTicks(8038),
                            Email = "admin@foodheaven.com",
                            FullName = "Admin User",
                            IsActive = true,
                            PasswordHash = "$2a$11$u5uEe3sVoX5v/b07GpQaL.23yGkPSgL9EcEqvR2cQ7szYzPzY.9kO",
                            Username = "admin"
                        });
                });
            ...
            modelBuilder.Entity("FoodHeaven.Models.MenuItem", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = 1,
                            Category = "Mains",
                            CreatedAt = new DateTime(2026, 1, 16, 19, 6, 12, 530, DateTimeKind.Local).AddTicks(3207),
                        ...
                        new
                        {
                            Id = 2,
                            Category = "Mains",
                            CreatedAt = new DateTime(2026, 1, 16, 19, 6, 12, 530, DateTimeKind.Local).AddTicks(3224),
                        ...
                        new
                        {
                            Id = 3,
                            Category = "Mains",
                            CreatedAt = new DateTime(2026, 1, 16, 19, 6, 12, 530, DateTimeKind.Local).AddTicks(3227),
                        ...
                        new
                        {
                            Id = 4,
                            Category = "Mains",
                            CreatedAt = new DateTime(2026, 1, 16, 19, 6, 12, 530, DateTimeKind.Local).AddTicks(3229),
                        ...
                        new
                        {
                            Id = 5,
                            Category = "Mains",
                            CreatedAt = new DateTime(2026, 1, 16, 19, 6, 12, 530, DateTimeKind.Local).AddTicks(3231),
                        ...
                        new
                        {
                            Id = 6,
                            Category = "Starters",
                            CreatedAt = new DateTime(2026, 1, 16, 19, 6, 12, 530, DateTimeKind.Local).AddTicks(3233),
                        ...
                        new
                        {
                            Id = 7,
                            Category = "Drinks",
                            CreatedAt = new DateTime(2026, 1, 16, 19, 6, 12, 530, DateTimeKind.Local).AddTicks(3235),
                        ...
                        new
                        {
                            Id = 8,
                            Category = "Healthy",
                            CreatedAt = new DateTime(2026, 1, 16, 19, 6, 12, 530, DateTimeKind.Local).AddTicks(3237),
                        ...
                        new
                        {
                            Id = 9,
                            Category = "Desserts",
                            CreatedAt = new DateTime(2026, 1, 16, 19, 6, 12, 530, DateTimeKind.Local).AddTicks(3238),
