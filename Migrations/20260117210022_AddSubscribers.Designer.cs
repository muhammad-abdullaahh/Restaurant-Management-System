...
namespace FoodHeaven.Migrations
{
    ...
    [Migration("20260117210022_AddSubscribers")]
            ...
            modelBuilder.Entity("FoodHeaven.Models.Admin", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1,
                            CreatedAt = new DateTime(2026, 1, 18, 2, 0, 19, 992, DateTimeKind.Local).AddTicks(9163),
                            Email = "admin@foodheaven.com",
                            FullName = "Admin User",
                            IsActive = true,
                            PasswordHash = "$2a$11$1tg6Ps6OgOKiwsM4RuKIy.DgPos5GzDjpG7eKPpNI4IyYXA8E4GZO",
                            Username = "admin"
                        });
                });
            ...
            modelBuilder.Entity("FoodHeaven.Models.MenuItem", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = 1,
                            Category = "Mains",
                            CreatedAt = new DateTime(2026, 1, 18, 2, 0, 19, 676, DateTimeKind.Local).AddTicks(7531),
                        ...
                        new
                        {
                            Id = 2,
                            Category = "Mains",
                            CreatedAt = new DateTime(2026, 1, 18, 2, 0, 19, 676, DateTimeKind.Local).AddTicks(7568),
                        ...
                        new
                        {
                            Id = 3,
                            Category = "Mains",
                            CreatedAt = new DateTime(2026, 1, 18, 2, 0, 19, 676, DateTimeKind.Local).AddTicks(7574),
                        ...
                        new
                        {
                            Id = 4,
                            Category = "Mains",
                            CreatedAt = new DateTime(2026, 1, 18, 2, 0, 19, 676, DateTimeKind.Local).AddTicks(7579),
                        ...
                        new
                        {
                            Id = 5,
                            Category = "Mains",
                            CreatedAt = new DateTime(2026, 1, 18, 2, 0, 19, 676, DateTimeKind.Local).AddTicks(7583),
                        ...
                        new
                        {
                            Id = 6,
                            Category = "Starters",
                            CreatedAt = new DateTime(2026, 1, 18, 2, 0, 19, 676, DateTimeKind.Local).AddTicks(7588),
                        ...
                        new
                        {
                            Id = 7,
                            Category = "Drinks",
                            CreatedAt = new DateTime(2026, 1, 18, 2, 0, 19, 676, DateTimeKind.Local).AddTicks(7765),
                        ...
                        new
                        {
                            Id = 8,
                            Category = "Healthy",
                            CreatedAt = new DateTime(2026, 1, 18, 2, 0, 19, 676, DateTimeKind.Local).AddTicks(7891),
                        ...
                        new
                        {
                            Id = 9,
                            Category = "Desserts",
                            CreatedAt = new DateTime(2026, 1, 18, 2, 0, 19, 676, DateTimeKind.Local).AddTicks(7899),
