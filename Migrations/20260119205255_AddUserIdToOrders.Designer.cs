...
namespace FoodHeaven.Migrations
{
    ...
    [Migration("20260119205255_AddUserIdToOrders")]
            ...
            modelBuilder.Entity("FoodHeaven.Models.Admin", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1,
                            CreatedAt = new DateTime(2026, 1, 20, 1, 52, 55, 166, DateTimeKind.Local).AddTicks(7954),
                            Email = "admin@foodheaven.com",
                            FullName = "Admin User",
                            IsActive = true,
                            PasswordHash = "$2a$11$2O6sl36j4f68Ph.YBCRECuoUf7UMB0HwOghlfvOhOfuOl.bp0psKS",
                            Username = "admin"
                        });
                });
            ...
            modelBuilder.Entity("FoodHeaven.Models.MenuItem", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = 1,
                            Category = "Mains",
                            CreatedAt = new DateTime(2026, 1, 20, 1, 52, 55, 19, DateTimeKind.Local).AddTicks(6440),
                        ...
                        new
                        {
                            Id = 2,
                            Category = "Mains",
                            CreatedAt = new DateTime(2026, 1, 20, 1, 52, 55, 19, DateTimeKind.Local).AddTicks(6466),
                        ...
                        new
                        {
                            Id = 3,
                            Category = "Mains",
                            CreatedAt = new DateTime(2026, 1, 20, 1, 52, 55, 19, DateTimeKind.Local).AddTicks(6470),
                        ...
                        new
                        {
                            Id = 4,
                            Category = "Mains",
                            CreatedAt = new DateTime(2026, 1, 20, 1, 52, 55, 19, DateTimeKind.Local).AddTicks(6472),
                        ...
                        new
                        {
                            Id = 5,
                            Category = "Mains",
                            CreatedAt = new DateTime(2026, 1, 20, 1, 52, 55, 19, DateTimeKind.Local).AddTicks(6474),
                        ...
                        new
                        {
                            Id = 6,
                            Category = "Starters",
                            CreatedAt = new DateTime(2026, 1, 20, 1, 52, 55, 19, DateTimeKind.Local).AddTicks(6476),
                        ...
                        new
                        {
                            Id = 7,
                            Category = "Drinks",
                            CreatedAt = new DateTime(2026, 1, 20, 1, 52, 55, 19, DateTimeKind.Local).AddTicks(6477),
                        ...
                        new
                        {
                            Id = 8,
                            Category = "Healthy",
                            CreatedAt = new DateTime(2026, 1, 20, 1, 52, 55, 19, DateTimeKind.Local).AddTicks(6479),
                        ...
                        new
                        {
                            Id = 9,
                            Category = "Desserts",
                            CreatedAt = new DateTime(2026, 1, 20, 1, 52, 55, 19, DateTimeKind.Local).AddTicks(6481),
