...
namespace FoodHeaven.Migrations
{
    ...
    [Migration("20260119185200_AddUserTable")]
            ...
            modelBuilder.Entity("FoodHeaven.Models.Admin", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1,
                            CreatedAt = new DateTime(2026, 1, 19, 23, 52, 0, 68, DateTimeKind.Local).AddTicks(1790),
                            Email = "admin@foodheaven.com",
                            FullName = "Admin User",
                            IsActive = true,
                            PasswordHash = "$2a$11$DUqm4IEsn2Wk.bu4H9XcDuiAze1LHUH1gjtmTOeT5fwo7Nuluo82u",
                            Username = "admin"
                        });
                });
            ...
            modelBuilder.Entity("FoodHeaven.Models.MenuItem", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = 1,
                            Category = "Mains",
                            CreatedAt = new DateTime(2026, 1, 19, 23, 51, 59, 923, DateTimeKind.Local).AddTicks(77),
                        ...
                        new
                        {
                            Id = 2,
                            Category = "Mains",
                            CreatedAt = new DateTime(2026, 1, 19, 23, 51, 59, 923, DateTimeKind.Local).AddTicks(101),
                        ...
                        new
                        {
                            Id = 3,
                            Category = "Mains",
                            CreatedAt = new DateTime(2026, 1, 19, 23, 51, 59, 923, DateTimeKind.Local).AddTicks(103),
                        ...
                        new
                        {
                            Id = 4,
                            Category = "Mains",
                            CreatedAt = new DateTime(2026, 1, 19, 23, 51, 59, 923, DateTimeKind.Local).AddTicks(105),
                        ...
                        new
                        {
                            Id = 5,
                            Category = "Mains",
                            CreatedAt = new DateTime(2026, 1, 19, 23, 51, 59, 923, DateTimeKind.Local).AddTicks(107),
                        ...
                        new
                        {
                            Id = 6,
                            Category = "Starters",
                            CreatedAt = new DateTime(2026, 1, 19, 23, 51, 59, 923, DateTimeKind.Local).AddTicks(109),
                        ...
                        new
                        {
                            Id = 7,
                            Category = "Drinks",
                            CreatedAt = new DateTime(2026, 1, 19, 23, 51, 59, 923, DateTimeKind.Local).AddTicks(110),
                        ...
                        new
                        {
                            Id = 8,
                            Category = "Healthy",
                            CreatedAt = new DateTime(2026, 1, 19, 23, 51, 59, 923, DateTimeKind.Local).AddTicks(112),
                        ...
                        new
                        {
                            Id = 9,
                            Category = "Desserts",
                            CreatedAt = new DateTime(2026, 1, 19, 23, 51, 59, 923, DateTimeKind.Local).AddTicks(113),
