...
namespace FoodHeaven.Migrations
{
    ...
    [Migration("20260116111016_AddReservationType")]
            ...
            modelBuilder.Entity("FoodHeaven.Models.Admin", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1,
                            CreatedAt = new DateTime(2026, 1, 16, 16, 10, 15, 746, DateTimeKind.Local).AddTicks(7485),
                            Email = "admin@foodheaven.com",
                            FullName = "Admin User",
                            IsActive = true,
                            PasswordHash = "$2a$11$s6lmBG4UgUB1DJFhttmfNe7dyAUB1s1khkBJRES5lQV/nZyu0MTPq",
                            Username = "admin"
                        });
                });
            ...
            modelBuilder.Entity("FoodHeaven.Models.MenuItem", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = 1,
                            Category = "Mains",
                            CreatedAt = new DateTime(2026, 1, 16, 16, 10, 15, 499, DateTimeKind.Local).AddTicks(7319),
                        ...
                        new
                        {
                            Id = 2,
                            Category = "Mains",
                            CreatedAt = new DateTime(2026, 1, 16, 16, 10, 15, 499, DateTimeKind.Local).AddTicks(7336),
                        ...
                        new
                        {
                            Id = 3,
                            Category = "Mains",
                            CreatedAt = new DateTime(2026, 1, 16, 16, 10, 15, 499, DateTimeKind.Local).AddTicks(7339),
                        ...
                        new
                        {
                            Id = 4,
                            Category = "Mains",
                            CreatedAt = new DateTime(2026, 1, 16, 16, 10, 15, 499, DateTimeKind.Local).AddTicks(7341),
                        ...
                        new
                        {
                            Id = 5,
                            Category = "Mains",
                            CreatedAt = new DateTime(2026, 1, 16, 16, 10, 15, 499, DateTimeKind.Local).AddTicks(7343),
                        ...
                        new
                        {
                            Id = 6,
                            Category = "Starters",
                            CreatedAt = new DateTime(2026, 1, 16, 16, 10, 15, 499, DateTimeKind.Local).AddTicks(7345),
                        ...
                        new
                        {
                            Id = 7,
                            Category = "Drinks",
                            CreatedAt = new DateTime(2026, 1, 16, 16, 10, 15, 499, DateTimeKind.Local).AddTicks(7347),
                        ...
                        new
                        {
                            Id = 8,
                            Category = "Healthy",
                            CreatedAt = new DateTime(2026, 1, 16, 16, 10, 15, 499, DateTimeKind.Local).AddTicks(7349),
                        ...
                        new
                        {
                            Id = 9,
                            Category = "Desserts",
                            CreatedAt = new DateTime(2026, 1, 16, 16, 10, 15, 499, DateTimeKind.Local).AddTicks(7351),
